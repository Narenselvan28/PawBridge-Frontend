...
const API_BASE_URL = 'https://pb-backend-e5hd.onrender.com';
                    ...
                    <div className="flex space-x-4 overflow-x-auto">
                        {tabs.map(tab => (
                            <button
                                ...
                                className={`flex items-center space-x-1 py-3 px-1 border-b-2 text-sm whitespace-nowrap ${activeTab === tab.key ? 'border-gray-800 text-gray-800' : 'border-transparent text-gray-500'
                                    }`}
                            >
                                <tab.icon size={16} />
                                <span>{tab.label}</span>
